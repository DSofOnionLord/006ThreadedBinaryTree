...
1) 입력 데이터를 읽어 threaded binary tree를 구성하시오. 입력 데이터는 다음과 같은 형식을 
...
③  위의 ②에서 구성한 threaded binary tree에서 특정 값을 갖는 노드의 오른쪽(inorder)에 하

나의 노드를 삽입하는 프로그램을 작성하시오.


④  위의 ③에서 구성한 threaded binary tree에서 특정 값을 갖는 노드의 오른쪽(inorder)에 하

나의 노드를 삭제하는 프로그램을 작성하시오.
